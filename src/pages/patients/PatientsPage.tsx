...
import { getMockPatientsByEhr, type EhrSystem, ehrSystemMeta } from '../../services/mockEhrData';
import classes from './PatientsPage.module.css';

// Combine all mock patients
const allPatients = [
  ...getMockPatientsByEhr('athena').map(p => ({ ...p, source: 'athena' as EhrSystem })),
  ...getMockPatientsByEhr('elation').map(p => ({ ...p, source: 'elation' as EhrSystem })),
  ...getMockPatientsByEhr('nextgen').map(p => ({ ...p, source: 'nextgen' as EhrSystem })),
];
        ...
        <Group justify="space-between" align="flex-start">
          <div>
            ...
            <Text c="dimmed" size="sm">
              {filteredPatients.length} patients from {sourceFilter ? ehrSystemMeta[sourceFilter as EhrSystem].name : 'all EHR systems'}
            </Text>
          </div>
          <Button
